...
export const DEMO_ORGANIZATIONS = [
  {
    ...
    settings: {
      branding: { primary_color: '#f97316', logo_url: null },
...
export const DEMO_PROJECTS = [
  {
    ...
    assessments: [
      ...
      mkAssessment('proj-001', 2, 'completed', 'completed', { ...SCORES_ACME, radScore: 51.8, maturityBand: 'Growth System Fragile', raps: { ...SCORES_ACME.raps, score: 28 } }),
  ...
  },
  {
    ...
    assessments: [
      mkAssessment('proj-002', 1, 'completed', 'completed', { ...SCORES_NOVA, radScore: 62.4, maturityBand: 'Growth System Fragile', raps: { ...SCORES_NOVA.raps, score: 41 } }),
      mkAssessment('proj-002', 2, 'completed', 'completed', { ...SCORES_NOVA, radScore: 71.2, maturityBand: 'Growth System Developing', raps: { ...SCORES_NOVA.raps, score: 52 } }),
...
The path forward requires focusing on crystallizing market positioning, strengthening competitive differentiation, and accelerating pipeline generation to improve win rates and shorten sales cycles.`,
  pillar_narratives: {
    ...
    p6: "Revenue Economics scores 56.0/100, indicating concerns about unit economics sustainability. The 20-30% win rate combined with long sales cycles creates challenging CAC:LTV dynamics.",
