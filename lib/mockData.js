...
export const DEMO_PROJECTS = [
  {
    ...
    assessments: [
      ...
      mkAssessment('proj-001', 2, 'completed', 'completed', { ...SCORES_ACME, radScore: 51.8, maturityBand: 'Growth System Developing', raps: { ...SCORES_ACME.raps, score: 28 } }),
  ...
  },
  {
    ...
    assessments: [
      mkAssessment('proj-002', 1, 'completed', 'completed', { ...SCORES_NOVA, radScore: 62.4, maturityBand: 'Growth System Developing', raps: { ...SCORES_NOVA.raps, score: 41 } }),
