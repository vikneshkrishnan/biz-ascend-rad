...
export const DIAGNOSTIC_PILLARS = [
  {
    id: 'p1', name: 'Commercial Baseline', weight: 0.15,
    questions: [
  ...
  {
    id: 'p5', name: 'Pipeline Generation', weight: 0.15,
    questions: [
  ...
  {
    id: 'p6', name: 'Revenue Economics', weight: 0.15,
    questions: [
...
export const MATURITY_BANDS = [
  ...
  { min: 60, max: 79, label: 'Growth System Developing', color: 'amber' },
  { min: 40, max: 59, label: 'Growth System Fragile', color: 'orange' },
  { min: 0, max: 39, label: 'Growth System At Risk', color: 'red' },
]
