...
export const DIAGNOSTIC_PILLARS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: 'p3_q13', text: 'What is your differentiated value compared to your customers?', type: 'qualitative' },
    ]
  },
  {
  ...
  },
  {
    ...
    questions: [
      { id: 'p6_q1', text: 'How well do you track and understand your Customer Acquisition Cost (CAC)?', type: 'scored', options: [{l:'We don\'t track how much it costs to acquire a new customer',s:1},{l:'We have a rough idea of acquisition cost but it\'s based on estimates, not actual data',s:2},{l:'We calculate our customer acquisition cost periodically, but don\'t break it down by channel or segment',s:3},{l:'Customer acquisition cost is tracked regularly by channel and segment, and informs where we invest',s:4},{l:'Acquisition cost is optimised — we know the cost and payback period for each channel and segment, and use it to guide spending decisions',s:5}] },
...
export const MATURITY_BANDS = [
  ...
  { min: 50, max: 79, label: 'Growth System Developing', color: 'band-developing' },
